        ...
        <div class="col-md-12" id="selector">
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  ...
                  <input name="name" type="search" placeholder="<?php echo $rowz['designation_name']; ?>" class="form-control">
                </div>
                <div class="col-md-6">
                  <label>Material Number:</label>
                    <input name="num" type="search" placeholder="<?php echo $rowz['number_name']; ?>" class="form-control">
                </div>
              </div>
              <?php
                }
              ...
              <?php 
                ...
                if (!empty($c) && empty($d) && empty($e)) {
                  $qwery = mysql_query("SELECT * FROM physical_prop WHERE material_desc_id = '$c'") or die(mysql_error());
                }if (!empty($d) && empty($c) && empty($e)) {
                  $qwery = mysql_query("SELECT * FROM physical_prop WHERE material_desc_id = '$d'") or die(mysql_error());
                }if (!empty($e) && empty($c) && empty($d)) {
                  $qwery = mysql_query("SELECT * FROM materialdesc_list WHERE designation_name = '$e'") or die(mysql_error());
                    ...
                    $id = $getid['id'];
                  $qwery = mysql_query("SELECT * FROM physical_prop WHERE material_desc_id = '$id'") or die(mysql_error());
                }
                if (empty($qwery)) {
                  ?>
                    <script>
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                   Density:
                  <input name="" type="search" placeholder="<?php echo $fetch['density'];?>" class="form-control">
                </div>
                <div class="col-md-6">
                  <label>Specific Electrical Resistance: </label>
                  <input name="" type="search" placeholder="<?php echo $fetch['specific_elect_resist'];?>" class="form-control">
                </div>
              </div>
              <div class="col-md-12">
                <p><b><u>Some Specific Properties =></u></b></p>
                <div class="col-md-6">
                  Magnetizable:
                  <input name="" type="search" placeholder="<?php echo $fetch['magnetizable'];?>" class="form-control">
                </div>
                <div class="col-md-6">
                  Weldable:
                  <input name="" type="search" placeholder="<?php echo $fetch['weldable'];?>" class="form-control">
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
                   Toughness Degree:
                  <input name="" type="search" placeholder="<?php echo $fetch['toughness_degree'];?>" class="form-control">
                </div>
                <div class="col-md-6">
                   Corrosion Resistance:
                    <input name="" type="search" placeholder="<?php echo $fetch['corrosion_resistance'];?>" class="form-control">
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
                  Cutting Property:
                    <input name="" type="search" placeholder="<?php echo $fetch['cutting_property'];?>" class="form-control">
                </div>
