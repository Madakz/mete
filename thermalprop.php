      ...
      <div class="container">
        ...
        <div class="col-md-12" id="selector">
            ...
            ?>
                ...
                <?php
                if (!empty($c) && empty($d) && empty($e)) {
                  $qwery = mysql_query("SELECT * FROM thermal_prop WHERE material_desc_id = '$c'") or die(mysql_error());
                }if (!empty($d) && empty($c) && empty($e)) {
                  $qwery = mysql_query("SELECT * FROM thermal_prop WHERE material_desc_id = '$d'") or die(mysql_error());
                }if (!empty($e) && empty($c) && empty($d)) {
                  $qwery = mysql_query("SELECT * FROM materialdesc_list WHERE designation_name = '$e'") or die(mysql_error());
                    ...
                    $id = $getid['id'];
                  $qwery = mysql_query("SELECT * FROM thermal_prop WHERE material_desc_id = '$id'") or die(mysql_error());
                }
                if (empty($qwery)) {
                  ?>
                    <script>
            ...
            <div class="col-md-12">
              <div class="col-md-6">
                ...
                <input name="name" type="search" placeholder="<?php echo $fetch['max_service_temp'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                Minimum Service Temperature:
                  <input name="num" type="search" placeholder="<?php echo $fetch['max_service_temp'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
               Melting Point: 
                <input name="name" type="search" placeholder="<?php echo $fetch['meltingpoint'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                Specific Heat:
                  <input name="num" type="search" placeholder="<?php echo $fetch['specific_heat'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                 Thermal Conductivity 
                <input name="name" type="search" placeholder="<?php echo $fetch['therm_cond'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                Thermal Expansion Coefficient
                  <input name="num" type="search" placeholder="<?php echo $fetch['therm_exp_coeff'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
