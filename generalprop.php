      ...
      <div class="container">
        ...
        <div class="col-md-12" id="selector">
            ...
            <div class="col-md-12">
                ...
                if (!empty($c) && empty($d) && empty($e)) {
                    $qwery = mysql_query("SELECT * FROM general_prop WHERE material_desc_id = '$c'") or die(mysql_error());
                }if (!empty($d) && empty($c) && empty($e)) {
                    $qwery = mysql_query("SELECT * FROM general_prop WHERE material_desc_id = '$d'") or die(mysql_error());
                }if (!empty($e) && empty($c) && empty($d)) {
                    $qwery = mysql_query("SELECT * FROM materialdesc_list WHERE designation_name = '$e'") or die(mysql_error());
                        ...
                        $id = $getid['id'];
                    $qwery = mysql_query("SELECT * FROM general_prop WHERE material_desc_id = '$id'") or die("Please make a selection");
                }
                if (empty($qwery)) {
                    ?>
                        <script>
                ...
                ?>
                <div class="col-md-6">
                    Standard Name/Classification:
                    <?php $sql = mysql_query("SELECT description FROM standard_name WHERE id = '$a'") or die(mysql_error()); 
                        while ($row = mysql_fetch_array($sql)) { ?>
                        

                    <input name="" type="search" placeholder="<?php echo $row['description'];?>" class="form-control">
                    <?php   
                        }
                    ?>
                </div>
                <div class="col-md-6">
                    Country of steel:
                    <input name="" type="search" placeholder="<?php echo $fetch['country'];?>" class="form-control">
                </div>
            </div>
            <div class="col-md-12">
                <div class="col-md-6">
                    Equivalence:
                    <input name="" type="search" placeholder="<?php echo $fetch['equivalence'];?>" class="form-control">
                </div>
                <div class="col-md-6">
                    Group of steel:
                    <input name="" type="search" placeholder="<?php echo $fetch['group_of_steel'];?>" class="form-control">
                </div>
            </div>
            <div class="col-md-12">
                <div class="col-md-12">
                    Application:
                    <input name="" type="search" placeholder="<?php echo $fetch['application'];?>" class="form-control">
                </div>
            </div>
            <div class="col-md-12">
                <div class="col-md-6">
