jQuery().ready(function($){
			...
			// alert('you selected Standard Name = '+$('#standard option:selected').text()+' ,Classification Type= '+$('#classG option:selected').text()+' And Designation Name = '+$('#design option:selected').text()
			// );
				// });
