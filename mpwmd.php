...
<html>
  <head>
    ...
    <script language="JavaScript" src="functiond.js"></script>
    ...
    <div class="jumbotron">
      <div class="container">
        <div class="col-md-12" id="headtop">
        	<h3>MATERIAL PROPERTIES WITH MATERIAL DESIGNATION</h3>
          <hr>
        </div>
          ...
          <form id="property" name="prop" action="" method="POST">
            ...
            <div class="col-md-12" id="top">
              ...
              <div class="col-md-8">
                ...
                <input type="hidden" name="designname" value="">
              </div>
            </div>
            <div class="col-md-12">
