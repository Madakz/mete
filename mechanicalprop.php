        ...
        <div class="col-md-12" id="selector">
            ...
            <div class="col-md-12">
              <div class="col-md-6">
                ...
                <input name="name" type="text" placeholder="<?php echo $rowz['designation_name']; ?>" class="form-control">
              </div>
              <div class="col-md-6">
                <label>Material Number:</label>
                  <input name="num" type="text" placeholder="<?php echo $rowz['number_name']; ?>" class="form-control">
              </div>
            </div>
              <?php
                }
              ...
              <?php 
              if (!empty($c) && empty($d) && empty($e)) {
                $qwery = mysql_query("SELECT * FROM mechanical_prop WHERE material_desc_id = '$c'") or die(mysql_error());
              }if (!empty($d) && empty($c) && empty($e)) {
                $qwery = mysql_query("SELECT * FROM mechanical_prop WHERE material_desc_id = '$d'") or die(mysql_error());
              }if (!empty($e) && empty($c) && empty($d)) {
                $qwery = mysql_query("SELECT * FROM materialdesc_list WHERE designation_name = '$e'") or die(mysql_error());
                  ...
                  $id = $getid['id'];
                $qwery = mysql_query("SELECT * FROM mechanical_prop WHERE material_desc_id = '$id'") or die(mysql_error());
              }
              if (empty($qwery)) {
                ?>
                  <script>
            ...
            <div class="col-md-12">
              <div class="col-md-12">
                <label>Condition:</label>
                 <select><option value="1">ANNEALED</option>
            ...
            <div class="col-md-12">
              <div class="col-md-6">
                Yield Strength: 
                <input name="" type="text" placeholder="<?php echo $fetch['yield_strength'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                Endurance Limit:
                  <input name="" type="text" placeholder="<?php echo $fetch['endurance_limit'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                Tensile Strength: 
                <input name="" type="text" placeholder="<?php echo $fetch['tensile_strength'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                Fracture Toughness:
                  <input name="" type="text" placeholder="<?php echo $fetch['fracture_toughness'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                Young's Modulus: 
                <input name="" type="text" placeholder="<?php echo $fetch['youngs_modulus'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                Poisson's Ratio:
                  <input name="" type="text" placeholder="<?php echo $fetch['poisons_ratio'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                Hardness: 
                <input name="" type="text" placeholder="<?php echo $fetch['hardness'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                Shear Modulus:
                  <input name="" type="text" placeholder="<?php echo $fetch['shear_modulus'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                Elongation: 
                <input name="" type="text" placeholder="<?php echo $fetch['elongation'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                 Impact Value:
                  <input name="" type="text" placeholder="<?php echo $fetch['impact_value'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                Reduction Of Area: 
                <input name="" type="text" placeholder="<?php echo $fetch['reduction_of_area'];?>" class="form-control">
              </div>
            ...
            <div class="col-md-12">
              <div class="col-md-12">
              REMARK: 
              <input name="" type="text" placeholder="<?php echo $fetch['remark'];?>" class="form-control">
              </div>  
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
