    ...
    <div class="jumbotron">
      <div class="container">
        <div class="col-md-12" id="headtop">
        	<h3>HEAT TREATMENT PROPERTIES</h3>
          <hr>
        </div>
        <div class="col-md-12" id="selector">
            ...
            <div class="col-md-12">
              ...
              <?php 
                  if (!empty($c) && empty($d) && empty($e)) {
                    $qwery = mysql_query("SELECT * FROM heat_treatment_prop WHERE material_desc_id = '$c'") or die(mysql_error());
                  }if (!empty($d) && empty($c) && empty($e)) {
                    $qwery = mysql_query("SELECT * FROM heat_treatment_prop WHERE material_desc_id = '$d'") or die(mysql_error());
                  }if (!empty($e) && empty($c) && empty($d)) {
                    $qwery = mysql_query("SELECT * FROM materialdesc_list WHERE designation_name = '$e'") or die(mysql_error());
                      ...
                      $id = $getid['id'];
                    $qwery = mysql_query("SELECT * FROM heat_treatment_prop WHERE material_desc_id = '$id'") or die(mysql_error());
                  }
                  if (empty($qwery)) {
                    ?>
                      <script>
            ...
            <div class="col-md-12">
              <div class="col-md-6">
                <label>Hot Working Temperature:</label>
                <input name="" type="search" placeholder="<?php echo $fetch['hot_working_temp'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                <label>Soft Annealing Temperature:</label>
                <input name="" type="search" placeholder="<?php echo $fetch['soft_annealing_temp'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                <label>Duration Time</label>
                <input name="" type="search" placeholder="<?php echo $fetch['duration_time'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                <label>Hardening Temperature:</label>
                <input name="" type="search" placeholder="<?php echo $fetch['hardening_temp'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
                <label>Media</label>
                <input name="" type="search" placeholder="<?php echo $fetch['media'];?>" class="form-control">
              </div>
              <div class="col-md-6">
                <label>Tempering Temperature:</label>
                <input name="" type="search" placeholder="<?php echo $fetch['tempering_temp'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-12">
                <label>Notes About Welding</label>
                <input name="" type="search" placeholder="<?php echo $fetch['notes_about_welding'];?>" class="form-control">
              </div>
            </div>
            <div class="col-md-12">
              <div class="col-md-6">
